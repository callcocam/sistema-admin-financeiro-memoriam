<x-auth-card>
    ...
    <div class="text-green-500 w-full my-5 mx-auto" wire:loading wire:target="store">
        ...
        <form wire:submit.prevent="store">
            ...
            <label class="block">
                ...
                <input wire:model="email" readonly type="email" class="form-input mt-1 block w-full rounded-md focus:border-indigo-600">
            </label>            
            <label class="block mt-3">
                <span class="text-gray-700 text-sm">{{ __('Password') }}</span>
                <input wire:model="password" type="password" class="form-input mt-1 block w-full rounded-md focus:border-indigo-600">
            </label>
            
            <label class="block mt-3">
                <span class="text-gray-700 text-sm">{{ __('Confirm Password') }}</span>
                <input wire:model="password_confirmation" type="password" class="form-input mt-1 block w-full rounded-md focus:border-indigo-600">
            </label>
            <div class="mt-6">
