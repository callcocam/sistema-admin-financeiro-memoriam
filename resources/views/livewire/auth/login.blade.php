    ...
    <x-slot name="title">
        ...
        <form wire:submit.prevent="authenticate">
            ...
            <label class="block">
                ...
                <input wire:model="email" type="email" class="form-input mt-1 block w-full rounded-md focus:border-indigo-600">
            </label>
            ...
            <div class="flex justify-between items-center mt-4">
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="remember" type="checkbox" class="form-checkbox text-indigo-600">
