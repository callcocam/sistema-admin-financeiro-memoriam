...
use SIGA\Table\HasUtils;
use SIGA\Table\Traits\CanBeHidden;
use SIGA\Table\Views\Traits\HasTypes;
...
class Column
{
    use CanBeHidden, HasTypes, HasUtils;
    ...
    {
        return $this->views_include_table($this->view);
    }
